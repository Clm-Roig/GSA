...
int stock() {
	...
	interface7J.x=(pos1.x)+40+pos1.w+300; interface7J.y=40; interface7J.w=20; interface7J.h=400;
	interface14J.x=(pos1.x)+40+pos1.w+600; interface14J.y=40; interface14J.w=3; interface14J.h=400;
	SDL_FillRect(screenSurface,&objet5,SDL_MapRGB(screenSurface->format,0, 0, 0));
	SDL_FillRect(screenSurface,&objet5,SDL_MapRGB(screenSurface->format,0, 0, 0));
