...
int stock() {
	...
	SDL_Rect barre4;
	SDL_Rect barre5;
	barre1.x=(pos1.x)+40+pos1.w; barre1.y=pos1.y+10; barre1.w=(float)(1/duree1)*600; barre1.h=40;
	barre2.x=(pos2.x)+40+pos2.w; barre2.y=pos2.y+10; barre2.w=(float)(1/duree2)*600; barre2.h=40;
	barre3.x=(pos3.x)+40+pos3.w; barre3.y=pos3.y+10; barre3.w=(float)(1/duree3)*600; barre3.h=40;
	barre4.x=(pos4.x)+40+pos4.w; barre4.y=pos4.y+10; barre4.w=(float)(1/duree4)*600; barre4.h=40;
	barre5.x=(pos5.x)+40+pos5.w; barre5.y=pos5.y+10; barre5.w=(float)(1/duree5)*600; barre5.h=40;
